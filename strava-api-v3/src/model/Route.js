...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PolylineMap', 'model/SummaryAthlete', 'model/SummarySegment', 'model/Waypoint'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PolylineMap'), require('./SummaryAthlete'), require('./SummarySegment'), require('./Waypoint'));
  } else {
    // Browser globals (root is window)
    if (!root.StravaApiV3) {
      root.StravaApiV3 = {};
    }
    root.StravaApiV3.Route = factory(root.StravaApiV3.ApiClient, root.StravaApiV3.PolylineMap, root.StravaApiV3.SummaryAthlete, root.StravaApiV3.SummarySegment, root.StravaApiV3.Waypoint);
  }
}(this, function(ApiClient, PolylineMap, SummaryAthlete, SummarySegment, Waypoint) {
  'use strict';
